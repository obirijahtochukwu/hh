...
export const UserDetailsComponent = ({}) => {
  ...
  return (
    <div className={styles.UserDetailsComponent}>
      <img
        src="/media/auction/Rectangle 56.svg"
        alt=""
      ...
      <div className={styles.aside}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            Burebista called upon Zalmoxis to send his champions, the Exalted,
            back to earth. The strongest of them were sent first. Theirs are the
            Origin Souls. Characters made from these Origin Souls will have
            benefits based on these elements.
          </div>
        </aside>
        ...
        <article className={styles.details}>
          ...
          {!bid ? (
            <section className="">
              ...
              <div onClick={() => setBid(true)} className={styles.bidBtn}>
                Place a Bid
              </div>
            </section>
          ) : (
  ...
  const products = [
    {
      ...
      price: "0.01 EGLD",
      time: "3h:30m:24s",
      img: "/media/auction/Rectangle 18 (3).svg",
    },
    {
      name: "Bored Ape Yacht Club",
      price: "0.01 EGLD",
      time: "3h:30m:24s",
      img: "/media/auction/Rectangle 18 (2).svg",
    },
    {
      name: "Bored Ape Yacht Club",
      price: "0.01 EGLD",
      time: "3h:30m:24s",
      img: "/media/auction/Rectangle 18 (1).svg",
    },
    {
      name: "Bored Ape Yacht Club",
      price: "0.01 EGLD",
      time: "3h:30m:24s",
      img: "/media/auction/Rectangle 18.svg",
    },
  ];
